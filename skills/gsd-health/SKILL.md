...
<!-- Workflow content (was: health.md) -->
<purpose>
...
```bash
node "$GSD_TOOLS" validate health $REPAIR_FLAG
```
...
```bash
node "$GSD_TOOLS" validate health
```
...
<process>
Execute the health workflow steps embedded above end-to-end.
