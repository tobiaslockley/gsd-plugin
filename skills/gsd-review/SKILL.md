...
<!-- Workflow content (was: review.md) -->
<purpose>
...
Commit:
```bash
node "$GSD_TOOLS" commit "docs: cross-AI review for phase {N}" --files {phase_dir}/{padded_phase}-REVIEWS.md
```
</step>
...
<process>
Execute the review workflow steps embedded above end-to-end.
</process>
