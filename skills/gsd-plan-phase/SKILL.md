...
<!-- Workflow content (was: plan-phase.md) -->
<purpose>
...
2. Disable Nyquist with the exact command:
   `node "$GSD_TOOLS" config-set workflow.nyquist_validation false`
...
<process>
Execute the plan-phase workflow steps embedded above end-to-end.
