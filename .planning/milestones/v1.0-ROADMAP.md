...
- [x] 02-02-PLAN.md -- MCP workflow tools and new-project integration
...
Plans:
- [x] 03-01-PLAN.md -- Create the dedicated `plugins/gsd` plugin root and staged runtime scaffold
- [x] 03-02-PLAN.md -- Migrate packaged skills, agents, workflows, and templates off legacy absolute paths
- [x] 03-03-PLAN.md -- Move GSD hooks and MCP registration into the packaged plugin
- [x] 03-04-PLAN.md -- Write lean phase memories to memdir at verification/completion time
- [x] 03-05-PLAN.md -- Add legacy-install migration and retire old update/setup assumptions
...
| 3. Plugin Packaging and Memory | 0/5 | Planning complete | - |
